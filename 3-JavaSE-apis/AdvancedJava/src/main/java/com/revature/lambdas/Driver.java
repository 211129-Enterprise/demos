...
public class Driver {
	...
	public static void main(String[] args) {
		...
		Collections.sort(employees, new Comparator<Employee>() {
			...
			@Override
			public int compare(Employee o1, Employee o2) { // compare(), not compareTo()
				// sort by employee name in ascending order by leveraging the String class's
				// compareTo() method because that class already implements the comparable interface
