...
import javax.validation.constraints.Pattern; // RESEARCH: JPA Specification vs Hibernate implementation and SPring data's role with booth
...
public class User {
	...
	// Here, since we're defining the JoinTable in the user class,
	// we declare that User.java OWNS the relationship
	@ManyToMany
