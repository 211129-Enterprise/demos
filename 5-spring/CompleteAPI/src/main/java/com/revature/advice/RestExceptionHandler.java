...
/**
 * All methods here will intercept certain exceptions that are sent back as 
 * HTTP responses from the Controller
 */
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * Intercept UserNotFound from the findByUsername Controller method
