...
public class ConnectionUtil {
	...
	public static Connection getConnection() { // this is similar to getInstance()
		...
		try {
			...
			//prop.load(new FileReader("C:\\Users\\markt\\Desktop\\project-0-MarkMartin00\\src\\main\\resources\\application.properties"));
			prop.load(new FileReader("C:\\Users\\markt\\Desktop\\projects\\demos\\project-0-MarkMartin00\\src\\main\\resources\\application.properties"));
			// I right clicked on the application.properties > went to properties than copy/pasted the exact location of the file
