// grab the elements from the page to work with
...
function ajaxCall() {
    ...
    // capture the id that hte user input
    ...
    xhr.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            // if we have successfully received the response we neeed to transform it to a JS Object
