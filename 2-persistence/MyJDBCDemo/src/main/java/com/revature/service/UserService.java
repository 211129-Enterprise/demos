...
public class UserService {
	...
	public User register(User u) {
		...
		if (u.getId() != 0) {
			//All User objects that HAVEN'T been persistsd to the DB have an id of 0
			throw new RegisterUserFailedException("User not valid to register because Id was " + u.getId() + " and not 0.");
			//let's make a custom exception called REgister UserFailed Exception to specify what went wrong
		}
		...
		//Is the generate PK -1? is it equal to the User's Id that wa passed thru the method
