...
public class UserServiceTests {
	...
	// declare a variable to point to the class to be tested
	private UserService userv;
	
	// declare the dependencies of the class to be tested
	private UserDAO mockDao;
	
	// how to mock private dependency?
	...
	public void setup() {
		...
		userv.udao = mockDao; // set the UserService instance's DAO property to be the mocked Dao
	...
	public void testRegisterUser_returnsNewPkAsId() {
		...
		// we're going to program the UserService's dao to return the fake pk when the insert method is called
		when(mockDao.insert(dummyUser)).thenReturn(fakePk);
		
		// the returned user of our register method SHOULD have the id that's returned by the insert() method on the dao
