...
public class Heist {
	...
	public static void main(String[] args) {
		...
		threads.forEach(t -> t.start()); // can only be called on Iterable Data structures
	}
	...
	// static class called Descending Hacker Thread extends HackerThraed
	private static class DescendingHackerThread extends HackerThread {
		...
		public void run() {
			...
			// the description. hacker-thread will iterate from MAX_PASSWORD - 0 and check if the
	...
	private static class PolicemanThread extends Thread {
		...
		public void run() {
			...
			// if we exit the for-loop say something like game over, hackers caught!
