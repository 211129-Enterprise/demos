...
// That one method defines how to order your objects of this user-defined class

// Now if I want to perform a binary search on a list of animals
// as long as those objects implement Comparable, they can be processed by the method.
