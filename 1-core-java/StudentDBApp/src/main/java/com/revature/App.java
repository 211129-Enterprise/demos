...
public class App {
	...
	public static void run() {
		...
		// let's print out the student array toString() BEFORE we start initializing it
...
;		
		...
		// for each element ask the user for firstName, lastName and gradeYear
			System.out.println("Plese enter the first name");
			String firstName = scan.next();
			
			System.out.println("Please enter the last name");
			String lastName = scan.next();
			
			System.out.println("What's the students's grade year:\n1 - Freshman\n2 - Sophmore\n3 - Junior\n4 - Senior");
		...
		// let's print out the student array toString() AFTER we start initializing it
			System.out.println("This is what's inside the students array with " + numOfStudents + " places");
			System.out.println(Arrays.toString(students));
	}
