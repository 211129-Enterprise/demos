...
public class Driver {
	...
	public static void main(String[] args) {
		...
		// even though tht ememory address is different remember that hashCode is NOT the address in memory!
		System.out.println(stringObject2.hashCode());
		System.out.println(str2.hashCode()); // represents bvalue of the objects properties (state)
		
		String str5 = "Hello";
		String str6 = str5 + " World"; // this is a mutation - str6 is sent to the general heap - this is the equivelent of String str6 = new String()
		System.out.println(str6 == str3);
		
		// let's send str 6 to the string pool
		String str6inPool = str6.intern(); // this returns a string object that matches the pattern of the gen heap object 
