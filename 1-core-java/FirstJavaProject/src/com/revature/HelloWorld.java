...
public class HelloWorld {
	...
	//ctrl +spacebar allow me to shortcut method signatures
	public static void main(String[] args) {
		...
		short shortNumber; // 16 bits of reserved memory
		...
		double decimal = 0.45; // 64 bits of reserved mem
		 ...
		 *  
		 *  Narrow Casting (Explicit) -- Need for manual conversion - Narrowing a bigger primitive vale 
		...
		System.out.println("The minimum value of an interger is equal to... " + min);
		...
		intList.add(obj1);
		intList.add(100); // this will automatically be autoboxed into an Integer object because the arrayList only stores objects of integer type.
