...
// Remember that our custom lass inherits from the java.lang.Object class
public class Person { // POJO = Plain Old Java Object)
	
	// properties (states)
	
	// Instance variables - properties specific to each Person object that't instantiated
	private String name;
	private int age;
	...
	public void introduce() {// void is a non-access modifier - specifies the return type which is nothing - it just does something
		...
		// properties of the objects that are created from the class
