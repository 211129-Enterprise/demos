...
public class Driver {
	...
	public static void main(String[] args) {
		...
		// wee need to run the toString static method
//		System.out.println(numbers);
		...
		for (int i = 0; i < numbers.length ; i++ ) {
			...
			// O(n) (# of operations increases linearly with the amount of data that's passed through the for loop
			numbers[i] = (i * 100);
		...
		System.out.println(Arrays.toString(fruit)); // ctrl + click open declaration
