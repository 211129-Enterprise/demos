...
public class ClassA {
	 ...
	 * 4 Pillars of OOP
	 * 
	 * - Abstraction (is the process of hiding information that is not necessary to be viewed by the end user)
	 * -Polymorphism
	 * -Inheritance
	 * -Encapsulation
	 * 
	 * Encapsulation is a mechanism in which data and methods can be wrapped
	 * together in a single unit. We can restrict access to this data by using access
	 * modifiers.
	 */
