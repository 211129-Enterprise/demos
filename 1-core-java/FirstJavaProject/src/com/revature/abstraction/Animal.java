...
public abstract class Animal {
	...
	// Abstract methods are methods that have no body and are intended to be
	// inherited and overridden.
	public abstract void makeSound();

	// if we add the version that takes an int here it works in frog, but now we
	// have to implement it in cat too...
